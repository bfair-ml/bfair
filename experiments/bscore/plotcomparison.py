...
leading_file_path = (
    "runs-victoria/v8 bscore-continuous (morph)/leading/.scores-all-leading.jsonl"
)
...
assert (
    model_labels_leading == model_labels_non_leading
), "Model labels do not match between leading and non-leading files."
...
axes[0].errorbar(
    x_leading,
    count_disparity_means_leading,
    yerr=count_disparity_std_leading,
    fmt="none",
    ecolor="blue",
    capsize=5,
    label="Leading (±SD)",
...
axes[0].errorbar(
    x_leading,
    count_disparity_means_leading,
    yerr=count_disparity_errors_leading,
    fmt="s",
    mew=4,
    mfc="darkblue",
    mec="darkblue",
...
axes[0].bar(
    ...
    width=bar_width,
    alpha=0.7,
    label="Non-Leading (Mean)",
)
axes[0].errorbar(
    x_non_leading,
    count_disparity_means_non_leading,
    yerr=count_disparity_std_non_leading,
    fmt="none",
    ecolor="orange",
    capsize=5,
    label="Non-Leading (±SD)",
)
axes[0].errorbar(
    x_non_leading,
    count_disparity_means_non_leading,
    yerr=count_disparity_errors_non_leading,
    fmt="s",
    mew=4,
    mfc="darkorange",
    mec="darkorange",
...
axes[1].errorbar(
    x_non_leading,
    log_score_means_non_leading,
    yerr=log_score_std_non_leading,
    fmt="none",
    ecolor="green",
    capsize=5,
    label="Non-Leading (±SD)",
...
axes[1].errorbar(
    x_non_leading,
    log_score_means_non_leading,
    yerr=log_score_errors_non_leading,
    fmt="s",
    mew=4,
    mfc="darkgreen",
    mec="darkgreen",
