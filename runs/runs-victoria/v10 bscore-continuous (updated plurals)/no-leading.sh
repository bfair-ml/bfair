python -m experiments.bscore --context continuous --dataset victoria-GPT3.5-independent --export-csv "runs-victoria/gpt3.5-independent.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes --use-morph yes --include-plurals yes >> "runs-victoria/.log-independent.txt"
python -m experiments.bscore --context continuous --dataset victoria-GPT4o-independent --export-csv "runs-victoria/gpt4o-independent.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes --use-morph yes --include-plurals yes >> "runs-victoria/.log-independent.txt"
python -m experiments.bscore --context continuous --dataset victoria-Llama_3-independent --export-csv "runs-victoria/llama3-independent.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes --use-morph yes --include-plurals yes >> "runs-victoria/.log-independent.txt"
python -m experiments.bscore --context continuous --dataset victoria-Mistral8x7b-independent --export-csv "runs-victoria/mistral8x7b-independent.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes --use-morph yes --include-plurals yes >> "runs-victoria/.log-independent.txt"
python -m experiments.bscore --context continuous --dataset victoria-Gemini_1.5-independent --export-csv "runs-victoria/gemini1.5-independent.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes --use-morph yes --include-plurals yes >> "runs-victoria/.log-independent.txt"
