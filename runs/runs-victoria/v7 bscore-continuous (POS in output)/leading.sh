python -m experiments.bscore --context continuous --dataset victoria-GPT3.5-leading --export-csv "runs-victoria/gpt3.5-leading.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes >> "runs-victoria/.log-leading.txt"
python -m experiments.bscore --context continuous --dataset victoria-GPT4o-leading --export-csv "runs-victoria/gpt4o-leading.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes >> "runs-victoria/.log-leading.txt"
python -m experiments.bscore --context continuous --dataset victoria-Llama_3-leading --export-csv "runs-victoria/llama3-leading.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes >> "runs-victoria/.log-leading.txt"
python -m experiments.bscore --context continuous --dataset victoria-Mistral8x7b-leading --export-csv "runs-victoria/mistral8x7b-leading.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes >> "runs-victoria/.log-leading.txt"
python -m experiments.bscore --context continuous --dataset victoria-Gemini_1.5-leading --export-csv "runs-victoria/gemini1.5-leading.csv" --use-root yes --lower-proper-nouns yes --semantic-check no --split-endings yes --inspect-professions yes >> "runs-victoria/.log-leading.txt"
